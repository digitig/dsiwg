...
\begin{itemize}
	\item \textcolor{dsiwgAccentColour}{1-3} \index{Artefact, Data}Data Artefacts SHALL be identified.
	\item \textcolor{dsiwgAccentColour}{2-3} Risks SHALL be identified and linked to \index{Artefact, Data}Data Artefacts and \index{Property!Data}Data Properties.
\end{itemize}
...
\begin{longtable}{|C{\dsiwgColumnWidth{0.5}}|C{\dsiwgColumnWidth{0.08}}|C{\dsiwgColumnWidth{0.08}}|C{\dsiwgColumnWidth{0.08}}|C{\dsiwgColumnWidth{0.08}}|C{\dsiwgColumnWidth{0.08}}|}
  ...
  \multicolumn{6}{|c|}{\dsiwgTextBF{Establish Context}}\\ \hline
	...
	1-3 Data Artefacts\index{Artefact, Data} SHALL be identified. & X & X & & & \\ \hline
  ...
  \multicolumn{6}{|c|}{\dsiwgTextBF{Identify Risks}}\\ \hline
	...
	2-3 Risks SHALL be identified and linked to Data Artefacts\index{Artefact, Data} and \index{Property!Data}Data Properties. & X & X & & X & \\ \hline
