...
\begin{itemize}
  \item Which data sets or \cbstart\glspl{item data}\cbend\ being received from other systems have \index{Property!Data}\glspl{data property} (such as timeliness\index{Timeliness Property}, \index{Completeness!Property}\gls{completeness}, \index{Consistency!Property}\gls{consistency}, \index{Fidelity/Representation Property}\cbstart\gls{fidelity}\cbend\ etc.) that are significant to patient safety? 
