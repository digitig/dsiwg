...
As with the Manufacturer, the Health Organization needs to \dsiwgTextBF{\dsiwgTextIT{Identify \glspl{Data Artefact}}} that are potential sources of safety hazards and understand the context of their use in the procurement / deployment lifecycles of the Health Organisation\index{Lifecycle}.
