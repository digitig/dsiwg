...
\begin{itemize}
  ...
  \item what existing barriers or mitigations\index{Mitigation} (physical, technical, procedural) exist to reduce the risk of loss of \index{Property!Data}\glspl{data property}? and
