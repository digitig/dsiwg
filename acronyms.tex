...
\begin{longtable}{|p{\dsiwgColumnWidth{0.2}}|L{\dsiwgColumnWidth{0.6}}|L{\dsiwgColumnWidth{0.2}}|}
  ...
  \cline{2-3}
  \multirow{-7}*{\index{Integrity Property|textbf}(data) Integrity} & The property of protecting the \index{Accuracy Property}\gls{accuracy} and completeness of assets, i.e., that which has value to the organization. & ISO 27001:2013 \cite{citation:ISO27001:2013}\\
  \hline
  ...
  \hline
  & A degree or level of confidence that the data provided meet the requirements of the user. These requirements include levels of \gls{accuracy}\index{Accuracy Property}, resolution\index{Resolution Property}, \cbstart\gls{dsal}assurance level\cbend\index{Assurance Level}, traceability, timeliness\index{Timeliness Property}, completeness, and format. & RTCA/DO-200A \cite{citation:ED76}\\
  \cline{2-3}
  & Process by which the \gls{ecs} database is produced, the source materials, the resolution\index{Resolution Property} and reproduction \index{Accuracy Property}\gls{accuracy} of chart features, and the correctness and completeness of data. & ISO\ 19379:2003 \cite{citation:ISO19379}\\
  \cline{2-3}
  ...
  \hline
  \raggedright{(data) Quality Attributes} & \Gls{accuracy}\index{Accuracy Property}, resolution\index{Resolution Property}, \index{Assurance Level}\cbstart\gls{dsal}\cbend, traceability, timeliness\index{Timeliness Property}, completeness and format. & RTCA/DO-200A \cite{citation:ED76}\\
  \hline
  ...
  \hline
  (data) Verification & Evaluation of the output of an \gls{aeronautical data} process to ensure correctness and \index{Consistency!With Inputs}consistency with respect to the inputs and applicable data standards, rules and conventions used in that process. & (EU) No 73/2010 \cite{citation:EU732010}\\
  \hline
