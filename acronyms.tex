...
\begin{longtable}{|p{\dsiwgColumnWidth{0.2}}|L{\dsiwgColumnWidth{0.6}}|L{\dsiwgColumnWidth{0.2}}|}
  ...
  \hline
  \raggedright{(data) Quality Attributes} & \Gls{accuracy}\index{Accuracy Property}, resolution\index{Resolution Property}, \index{Assurance Level}assurance level, traceability, timeliness\index{Timeliness Property}, completeness and format. & RTCA/DO-200A \cite{citation:ED76}\\
  \hline
