...
\begin{longtable}{|p{\dsiwgColumnWidth{0.2}}|L{\dsiwgColumnWidth{0.6}}|L{\dsiwgColumnWidth{0.2}}|}
  ...
  \cline{2-3}
  \multirow{-7}*{\index{Integrity Property|textbf}(data) Integrity} & The property of protecting the \index{Accuracy Property}accuracy and completeness of assets, i.e., that which has value to the organization. & ISO 27001:2013 \cite{citation:ISO27001:2013}\\
  \hline
  ...
  \cline{2-3}
  & Process by which the \gls{ecs} database is produced, the source materials, the resolution\index{Resolution Property} and reproduction \index{Accuracy Property}accuracy of chart features, and the correctness and completeness of data. & ISO\ 19379:2003 \cite{citation:ISO19379}\\
  \cline{2-3}
