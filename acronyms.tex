...
\begin{longtable}{|p{\dsiwgColumnWidth{0.2}}|L{\dsiwgColumnWidth{0.6}}|L{\dsiwgColumnWidth{0.2}}|}
  ...
  \hline
  (data) Correctness & \Gls{completeness}, \index{Consistency!Self}self-\gls{consistency}, protection against alteration or corruption and \index{Consistency!With Requirements}\gls{consistency} with the functional requirements of the data-driven system. & IEC 61508 Part 3 \cite{citation:iec615083}\\
  \hline
  ...
  \cline{2-3}
  & Process by which the \gls{ecs} database is produced, the source materials, the resolution\index{Resolution Property} and reproduction \index{Accuracy Property}\gls{accuracy} of chart features, and the \gls{correctness} and \gls{completeness} of data. & ISO\ 19379:2003 \cite{citation:ISO19379}\\
  \cline{2-3}
