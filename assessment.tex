...
\dsiwgTextBF{Note: this questionnaire only provides an initial \gls{odr} assessment. Further work is required to establish the safety data risks in detail such as determining a \acrfull{dsal}\index{Assurance Level!Data} for relevant data sets.}
