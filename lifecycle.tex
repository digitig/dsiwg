...
In these cases, the \gls{dataset} is the same but the context of its use changes the safety significance and therefore the level of assurance that it may require. It follows that the assessed \index{Assurance Level!Data}assurance level of a \gls{dataset} is also predicated on where and when in the lifecycle the \gls{dataset} will be applied. 
