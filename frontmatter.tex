...
\begin{longtable}
  ...
  \\\hline
  {3.6} & {The \acrshort{dsiwg} Team} & {For publication at \acrshort{sss}'24} & {\cbstart 13-FEB-2024\cbend}
  \\\hline
\end{longtable}
%
...
%      \item A discussion of the risks of AI and autonomy (\dsiwgRef{Appendix}{bkm:autonomy});
      \item \cbstart An introduction to the concepts of both Dark and Dazzle Data (\dsiwgRef{Appendix}{bkm:darkdazzledata});\cbend
...
%      \item \cbstart An introduction to the Radish tool, that has been developed to assist in the application of the guidance within this document (\dsiwgRef{Appendix}{bkm:radish}).\cbend
