...
however Dazzle Data can mask, distort or prevent use of the real or desired data.
...
\begin{longtable}{|L{\dsiwgColumnWidth{0.17}}|L{\dsiwgColumnWidth{0.17}}|C{\dsiwgColumnWidth{0.17}}|C{\dsiwgColumnWidth{0.17}}|L{\dsiwgColumnWidth{0.32}}|}
  ...
  \tick & \tick &
  If the \gls{lifetime}\cbstart\ erroneously ends too early then\cbend\ the data is lost -- a dark data problem. Conversely if the \gls{lifetime} is too long it is potentially a dazzle situation.\\
  \hline
  %
