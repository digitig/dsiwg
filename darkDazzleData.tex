...
% Comparison table
%
\subsection{Links between Dark Data / Dazzle Data and \glsfmtlongpl{Data Property}}
...
\begin{longtable}{|L{\dsiwgColumnWidth{0.17}}|L{\dsiwgColumnWidth{0.17}}|C{\dsiwgColumnWidth{0.17}}|C{\dsiwgColumnWidth{0.17}}|L{\dsiwgColumnWidth{0.32}}|}
  \caption{\glscapitalisewords{\Glspl*{Data Property}} Affected by Dark Data and / or  Dazzle Data Issues}
  \label{tab:DarkDazzleComparison}
  \\\hline\TableHeadColour{\glscapitalisewords{\Gls*{Data Property}}} & \TableHeadColour{Explanation} & \TableHeadColour{Dark Data --- missing data} & \TableHeadColour{Dazzle data --- obscuring data} & \TableHeadColour{Notes}\\\hline
  \endfirsthead
  \caption[]{\glscapitalisewords{\Glspl*{Data Property}} Affected by Dark Data and / or  Dazzle Data Issues (continued)}
  \\\hline\TableHeadColour{\glscapitalisewords{\Gls*{Data Property}}} & \TableHeadColour{Explanation} & \TableHeadColour{Dark Data --- missing data} & \TableHeadColour{Dazzle data --- obscuring data} & \TableHeadColour{Notes}\\\hline
  \endhead
