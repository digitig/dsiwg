...
\begin{longtable}{|C{\dsiwgColumnWidth{0.1}}|L{\dsiwgColumnWidth{0.2}}|L{\dsiwgColumnWidth{0.7}}|}
  ...
  {13} & {\cbstart Staffing\cbend}\index{Staffing Data} & {Data related to staff training, competency, certification and permits}\\\hline
...
\begin{longtable}{|C{\dsiwgColumnWidth{0.19}}|C{\dsiwgColumnWidth{0.27}}|C{\dsiwgColumnWidth{0.27}}|C{\dsiwgColumnWidth{0.27}}|}
  ...
  \multirow{-2}*{\TableHeadColourCX{}} & \TableDimColourCX{\cbstart High\cbend} & \TableDimColourCX{Medium} & \TableDimColourCX{Low}\\\hline
  \endfirsthead
...
which were defined in \autoref{tab:PropertiesOfData} have been assigned abbreviations
using the scheme shown in \autoref{tab:DataPropertyAbbreviations}.

\begin{longtable}{|L{\dsiwgColumnWidth{0.3}}|C{\dsiwgColumnWidth{0.2}}|}
  \caption{\index{Property!Data}Data property abbreviations}
  \label{tab:DataPropertyAbbreviations}
  \\\hline
  \TableHeadColour{Data Property} & \TableHeadColourCX{Abbreviation}\\
  \hline
  \endfirsthead
    \caption[]{Data property abbreviations (continued)}
  \\\hline
  \TableHeadColour{Data Property} & \TableHeadColourCX{Abbreviation}\\
  \hline
  \endhead
  ...
  \endfoot
  \endlastfoot
  Integrity\index{Integrity Property} & I\\\hline
  Completeness\index{Completeness!Property} & C\\\hline
  Consistency\index{Consistency!Property} & N\\\hline
  Continuity\index{Continuity Property} & Y\\\hline
  Format\index{Format Property} & O\\\hline
  Accuracy\index{Accuracy Property} & A\\\hline
  Resolution\index{Resolution Property} & R\\\hline
  Traceability\index{Traceability Property} & T\\\hline
  Timeliness\index{Timeliness Property} & M\\\hline
  Verifiability\index{Verifiability Property} & V\\\hline
  Availability\index{Availability Property} & L\\\hline
  Fidelity/Representation\index{Fidelity/Representation Property} & F\\\hline
  Priority\index{Priority Property} & P\\\hline
  Sequencing\index{Sequencing, Data} & Q\\\hline
  Intended Destination / Usage\index{Intended Destination/Usage Property} & U\\\hline
  Accessibility\index{Accessibility Property} & B\\\hline
  Suppression\index{Suppression Property} & S\\\hline
  History\index{History Property} & H\\\hline
  Lifetime\index{Lifetime Property} & E\\\hline
  Disposability / Deletability\index{Disposability/Deletability Property} & D\\\hline
  Goldilocks\index{Goldilocks Property} & G\\\hline
   Analysability\index{Analysability Property} & Z\\\hline
   Explainability\index{Explainability Property} & X\\\hline
\end{longtable}
...
\begin{itemize}
    ...
    \item Determine the list of applicable \index{Property!Data}Data Properties, using the abbreviations in \autoref{tab:DataPropertyAbbreviations}. This will generally provide a list of several applicable abbreviations.
\end{itemize}
...
\begin{itemize}
    ...
    \item The \index{Artefact, Data}data artefact holds one or more of the \index{Integrity Property}properties \index{Integrity Property}Integrity, \index{Completeness!Property}Completeness or Verifiability\index{Verifiability Property} (``I'', ``C'' or ``V'' from \autoref{tab:DataPropertyAbbreviations}).
\end{itemize}
...
Many dots have been placed in the table to indicate Data Categories\index{Category!Data} and \index{Property!Data}Data Properties which are not applicable to the Technique under consideration. The dots enable the tables to be assessed very quickly, as they enable the letters representing specific Data Categories\index{Category!Data} and \index{Property!Data}Data Properties to always be presented in the same position within the table. For example, the \index{Property!Data}Data Property Verifiability\index{Verifiability Property} (``V'' from \autoref{tab:DataPropertyAbbreviations} can easily be seen to appear against the first two Techniques of \autoref{tab:MethodsSystemDesign}, whereas it does not appear in the next seven Techniques --- this can be seen without actually reading the text, but merely looking at the pattern presented by the letters and dots. 
...
\begin{longtable}
  ...
  \hline
  DD.05 & Client Sign-off & \dsiwgTextTT{VI.PJ} & R & R & HR & HR & \cbstart Agreement from the client that the system architecture and design are appropriate for the data considered.\cbend & \dsiwgTextTT{......R..V.............}\\
  \hline
  DD.06 & Data Quality Correction Mechanisms & \dsiwgTextTT{...P.} & - & R & HR & HR & \cbstart Design incorporates a data quality management system.\cbend & \dsiwgTextTT{IC.Y...................}\\
  \hline
  ...
  \cbstart To specify data (or data formats) in a precise, mathematical manner.\cbend &
...
\endlastfoot
  ...
  \hline
  DI.13 & Update Comparison & \dsiwgTextTT{VIDPJ} & - & R & R & HR & \cbstart Updated data is compared to its previous version (e.g., so the list of changed elements can be compared with a supplier-generated list).\cbend & \dsiwgTextTT{.......T.........H..G..}\\
  \hline
\end{longtable}
