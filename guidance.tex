...
The Goldilocks\index{Goldilocks Property} property is related to the \cbstart data volume problem \cbend\ discussed in \hyperref[tab:issues]{section}~\ref{tab:issues}, however, given the importance of data sizing and the experience of real-world incidents this is now a separate property.
...
Explainability \cbstart describes the ability to establish what the purpose and effect data (and especially changes to data) has on a system
