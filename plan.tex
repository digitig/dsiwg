...
%
%================================================================================
\section{Data Safety Management Plan (Informative)} \label{bkm:plan}
...
\begin{enumerate}
  ...
  \begin{itemize}
    \item System Integrity Level (SIL), etc., Implications (What impact does the \gls{dsal}\index{Assurance Level!Data} have on the required SIL, or similar measure, and vice versa?);
