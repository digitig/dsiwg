...
\begin{enumerate}
  ...
  \begin{itemize}
    \item \cbstart\gls{sil}, etc., Implications (What impact does the \gls{dsal}\index{Assurance Level!Data} have on the required \gls{sil}, or similar measure, and vice versa?);
