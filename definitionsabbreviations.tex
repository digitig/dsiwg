...
\begin{longtable}{|L{\dsiwgColumnWidth{0.35}}|L{\dsiwgColumnWidth{0.65}}|}
  ...
  \endlastfoot
	...
	{\index{Data Safety Assurance Level|see{Assurance Level, Safety, Data}}\index{Assurance Level!Safety!Data}Data Safety Assurance Level} & {An indication of the level of rigour with which relevant \glspl{data property} should be demonstrated for appropriate \index{Artefact, Data}\glspl{data artefact}.}\\\hline
