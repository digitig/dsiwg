...
\begin{longtable}{|C{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.16}}|L{\dsiwgColumnWidth{0.37}}|L{\dsiwgColumnWidth{0.14}}|L{\dsiwgColumnWidth{0.1}}|L{\dsiwgColumnWidth{0.15}}|}
  ...
  %
	...
	& Air & 2018 \& 2019 & \index{Integrity Property}Integrity, \index{Completeness!Property}Completeness, \index{Accuracy Property}\gls{accuracy}\vspace{1ex} \index{Availability Property}Availability, Verifiability\index{Verifiability Property}, \index{Fidelity/Representation Property}Fidelity / representation\\ 
	\hline
...
\begin{itemize}
    \item The \gls{mcas}\index{MCAS} system was not described in the pilot's manual and training materials (Data Category: Staffing\index{Staffing Data}, \index{Property!Data}Properties lost: \dsiwgTextIT{\index{Availability Property}Availability})
    \item There was no indication to the pilots that \gls{mcas}MCAS\index{MCAS} was active (Data Category: Dynamic\index{Dynamic Data}; \index{Property!Data}Properties lost: \dsiwgTextIT{\index{Availability Property}Availability}).
...
%    \item The ability of MCAS to detect a faulty sensor was only tested with faulty sensors giving a value 24° higher than measured (Data Category: Verification; Properties lost: \dsiwgTextIT{Completeness}).
    ...
    \item During flight testing, adaptation\index{Adaptation Data} was changed to give \gls{mcas}\index{MCAS} more authority, without a new safety impact assessment (Data Category: Adaptation\index{Adaptation Data}; \index{Property!Data}Properties lost: \dsiwgTextIT{Verifiability\index{Verifiability Property}}).
\end{itemize}
