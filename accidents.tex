...
This incident potentially illustrates the importance of the \dsiwgTextIT{\index{Fidelity/Representation Property}\gls{fidelity}} and \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} \index{Property!Data}\glspl{data property}, with respect to the \gls{egpws} \gls{database}, and the \index{Accuracy Property}\gls{accuracy} \index{Property!Data}\gls{data property}, with respect to the route guides.
