...
\begin{longtable}{|C{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.16}}|L{\dsiwgColumnWidth{0.37}}|L{\dsiwgColumnWidth{0.14}}|L{\dsiwgColumnWidth{0.1}}|L{\dsiwgColumnWidth{0.15}}|}
  ...
  \label{tab:Incidents}
  \\\hline\TableHeadColourC{Ref.} & \TableHeadColour{Title} & \TableHeadColour{Summary} & \TableHeadColour{Domain} & \TableHeadColour{Year} & \TableHeadColour{\index{Property!Data}\glsxtrlong{Data Property}}\\\hline
  \endfirsthead
  \caption[]{Incidents and accidents (continued)}
  \\\hline\TableHeadColourC{Ref.} & \TableHeadColour{Title} & \TableHeadColour{Summary} & \TableHeadColour{Domain} & \TableHeadColour{Year} & \TableHeadColour{\index{Property!Data}\glsxtrlong{Data Property}}\\\hline
  \endhead
  ...
  Defence & 1415 &
  Integrity\index{Integrity Property}, Completeness\index{Completeness Property},
  ...
  %
	...
	\hline
	\ref{bkm:incacc:a400m} & A400M Torque Calibration Parameters & A software update apparently wiped the engine torque control parameters. Aircraft crash; four fatalities. & Air (Defence) & 2015 & \index{Completeness!Property}Completeness \\
	\hline
...
\subsection{Battle of Agincourt}\index[locationidx]{France}\label{bkm:incacc:agincourt}
  ...
  Agincourt due to their misconceptions about its range, accuracy, and impact on their cavalry.
  ...
  \dsiwgTextIT{\index{Completeness Property}Completeness}.
  ...
  \dsiwgTextIT{\index{Accuracy Property}Accuracy} and the
...
\Gls{Data Property} involved: \dsiwgTextIT{\index{Integrity Property}Integrity.}
...
\begin{itemize}
    \item The MCAS\index{MCAS} system was not described in the pilot's manual and training materials (Data Category: Staffing\index{Staffing Data}, \index{Property!Data}Properties lost: \dsiwgTextIT{\index{Availability Property}Availability})
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Fidelity/Representation Property}fidelity / representation} \gls{Data Property}, with respect to the modelling, and the \dsiwgTextIT{\index{Integrity Property}integrity} \index{Property!Data}\gls{Data Property}, with respect to the persistence time of the saturation flag.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}integrity} \index{Property!Data}\gls{Data Property}. It also shows the applicability of Data Safety Guidance to areas that are not traditionally encompassed by safety engineering.
...
This accident highlights the importance of the \dsiwgTextIT{\index{Completeness!Property}completeness} \index{Property!Data}\gls{Data Property}, specifically with respect to the torque calibration\index{Torque Calibration} parameters.
...
This incident highlights the importance of the \dsiwgTextIT{resolution} \index{Property!Data}\gls{Data Property}, specifically with regards to resolving a trawler and a merchant vessel. It also highlights the importance of the \dsiwgTextIT{\index{Integrity Property}integrity}, specifically with regards to the information provided from the sonar\index{Sonar} team to the command team. 
...
This incident demonstrates the importance of the \dsiwgTextIT{\index{Completeness!Property}completeness} Data \index{Property!Data}y (i.e., ensuring that the mandatory ``Gender Description'' field was completed) and the \dsiwgTextIT{\index{Fidelity/Representation Property}fidelity / representation} \index{Property!Data}\gls{Data Property} (i.e., ensuring the calculated aircraft loads and balances reflect the real situation). It also illustrates some potential difficulties associated with the use of default data.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Consistency!Property}consistency} \index{Property!Data}\gls{Data Property}, with respect to the differences between the \gls{gcs} settings and the aircraft it was meant to be controlling. It also highlights the importance of the \dsiwgTextIT{verifiability}\index{Verifiability Property} \gls{Data Property}, with respect to the \gls{gcs} settings (and, in particular, the limitations of using checklists to verify data).
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}integrity} \index{Property!Data}\gls{Data Property}, with respect to the \gls{gtols} data loaded by the crew.
...
This incident highlights the role of the \dsiwgTextIT{\index{Integrity Property}integrity} \index{Property!Data}\gls{Data Property}, with respect to the chart plots, and the \dsiwgTextIT{\index{Accuracy Property}accuracy} \index{Property!Data}\gls{Data Property}, with respect to the alarm thresholds which did not reflect the Captain's wishes.
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Integrity Property}integrity} \index{Property!Data}\gls{Data Property}, with respect to the control table data, and the \dsiwgTextIT{\index{Completeness!Property}completeness} \index{Property!Data}\gls{Data Property}, with respect to data produced by the testing and the quality control processes.
...
This incident highlights the importance of the \dsiwgTextIT{verifiability} \index{Verifiability Property}\gls{Data Property}, especially with regards to default (and adaptation\index{Adaptation Data}) data.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Accuracy Property}accuracy} \index{Property!Data}\gls{Data Property}, with regards to the information displayed on the electronic chart. It also highlights the importance of the \dsiwgTextIT{\index{Completeness!Property}completeness} \index{Property!Data}\gls{Data Property}, with regards to training (and training records) and the \dsiwgTextIT{intended destination / usage} \index{Property!Data}\gls{Data Property}, with regards to the inappropriate use of the \gls{vms} data.
...
This incident highlights the importance of the \dsiwgTextIT{timeliness\index{Timeliness Property}} \index{Property!Data}\gls{Data Property}, specifically with regards to the charts. The \dsiwgTextIT{\index{Completeness!Property}completeness} \index{Property!Data}\gls{Data Property} is also relevant, given that neither the ``after hours'' changes on Fridays nor the local \gls{notam} were communicated appropriately.
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Integrity Property}integrity} \index{Property!Data}\gls{Data Property}, with respect to calculated release dates. The \dsiwgTextIT{verifiability} \index{Verifiability Property}\gls{Data Property} is also relevant, noting that the calculation of the release date was readily verifiable (as shown by the actions of the family of the assault victim).
...
This incident highlights the importance of the \dsiwgTextIT{\index{Consistency!Property}consistency} \index{Property!Data}\gls{Data Property}.
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Continuity Property}} \index{Property!Data}\gls{Data Property}, with respect to the \gls{msaw} coverage, and the \dsiwgTextIT{\index{Fidelity/Representation Property}fidelity / representation} \index{Property!Data}\gls{Data Property},
regarding
