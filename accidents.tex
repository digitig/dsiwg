...
\begin{longtable}{|C{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.16}}|L{\dsiwgColumnWidth{0.37}}|L{\dsiwgColumnWidth{0.14}}|L{\dsiwgColumnWidth{0.1}}|L{\dsiwgColumnWidth{0.15}}|}
  ...
  %
	...
	\hline
	\ref{bkm:incacc:nimitzhill} & Crash into Nimitz Hill, Guam & \Gls{cfit}; the ground-based minimum safe altitude warning designed to alert air traffic controllers had been inhibited. 228 fatalities; 26 serious injuries. & Air & 1997 & \index{Continuity Property}Continuity, \index{Fidelity/Representation Property}Fidelity / representation \\
	\hline
        \ref{bkm:incacc:sanbernardino} &
