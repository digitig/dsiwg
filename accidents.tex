...
\begin{longtable}{|C{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.43}}|L{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.43}}|}
  ...
  \hline
    ...
    %%%
    \ref{bkm:incacc:log4j} & \multicolumn{3}{l|}{\cbstart Java log4j Library\cbend\ Vulnerability}\\
    \hline
    %%%
...
\begin{longtable}{|C{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.16}}|L{\dsiwgColumnWidth{0.37}}|L{\dsiwgColumnWidth{0.14}}|L{\dsiwgColumnWidth{0.1}}|L{\dsiwgColumnWidth{0.15}}|}
  ...
  Accountancy & 1999 & \Gls{integrity}\index{Integrity Property}, \gls{completeness}\index{Completeness Property}, \gls{traceability}\index{Traceability Property}, \gls{verifiability}\index{Verifiability Property}, \gls{history}\index{History Property}\\ 
  ...
  Defence & 1415 &
  \Gls{integrity}\index{Integrity Property}, \gls{completeness}\index{Completeness Property},
  Accuracy\index{Accuracy Property}, \gls{fidelity}\index{Fidelity / Representation Property},
  ...
  \index{Traceability Property}\gls{traceability},
  \index{Fidelity / Representation Property}\gls{fidelity}\\
  \hline
  %
  ...
  &
  Policing and Medical & 2021 & \index{Integrity Property}\Gls{integrity},
  ...
  %
        ...
        Internet & 2021 & \index{Integrity Property}\Gls{integrity}\\
        \hline
        %
        ...
        Medical & 2021 & \index{Integrity Property}\Gls{integrity}, \index{Accuracy Property}\gls{accuracy}, \gls{traceability}, \gls{verifiability}\index{Verifiability Property}\\
        \hline
        ...
        Medical & 2020 & \index{Integrity Property}\Gls{integrity}, \index{Completeness!Property}\gls{completeness}, \gls{timeliness}\index{Timeliness Property}, \index{Availability Property}\gls{availability}, \index{Fidelity / Representation Property}\gls{fidelity}\\
        \hline
	\ref{bkm:incacc:737max8} & Boeing 737 MAX~8 crashes &
	...
	& Air & 2018 \& 2019 & \index{Integrity Property}\Gls{integrity}, \index{Completeness!Property}\gls{completeness}, \index{Accuracy Property}\gls{accuracy}\vspace{1ex} \index{Availability Property}\gls{availability}, \gls{verifiability}\index{Verifiability Property}, \index{Fidelity / Representation Property}\gls{fidelity}\\ 
	\hline
        ...
        & Space & 2017 & \index{Fidelity / Representation Property}\Gls{fidelity}, \index{Integrity Property}\gls{integrity}, \gls{verifiability}\index{Verifiability Property} \\
        \hline
	\ref{bkm:incacc:cambrian} & Cambrian Line Data Loss &
	Speed restriction data failed to be passed to trains, placing pedestrians on level crossings at risk.
	& Rail & 2017 & \index{Availability Property}\gls{availability}, \gls{history}\index{History Property} \\ 
	\hline
	\ref{bkm:incacc:irishsar} & Loss of Irish rescue Helicopter & At the time of writing, the investigation\index{Investigation!Incident / Accident} is continuing; possible controlled flight into terrain; possible issues with terrain / obstacle \glspl{database}. Four fatalities. & Air & 2017 & \index{Fidelity / Representation Property}\Gls{fidelity}, \index{Completeness!Property}\gls{completeness}, \index{Accuracy Property}\gls{accuracy} \\
	\hline
	\ref{bkm:incacc:schiaparelli} & Loss of Schiaparelli Mars Lander & High rates led to the saturation of the \gls{imu}; the lander prematurely believed it was on the ground and released its parachute; the lander was lost. The high rates should have been expected, but were not due to modelling deficiencies. & Space & 2016 & \index{Fidelity / Representation Property}\Gls{fidelity}, \index{Integrity Property}\gls{integrity} \\
	\hline
	\ref{bkm:incacc:comintercept} & Interception of Communications & Incorrect data was disclosed during an investigation\index{Investigation!Criminal} into indecent images. A welfare check was delayed on a child believed to be in crisis. & Policing & 2015 & \index{Integrity Property}\Gls{integrity} \\ 
	\hline
	...
	\hline
	\ref{bkm:incacc:subtrawler} & Royal Navy Submarine, Trawler \dsiwgTextIT{Karen}\index{Trawler Karen} & A royal Navy submarine snagged the fishing gear of the trawler \dsiwgTextIT{Karen}. The trawler was dragged backwards at about seven knots and suffered structural damage. & Maritime & 2015 & \Gls{resolution}, \index{Integrity Property}\gls{integrity} \\
	\hline
	\ref{bkm:accinc:turkisha330} & Turkish Airlines A330 & Inaccurate navigation data, relating to runway location, led to touchdown with left main gear off the paved surface. Aircraft written off. & Air & 2015 & \index{Accuracy Property}\Gls{accuracy}, \gls{timeliness}\index{Timeliness Property}, \gls{verifiability}\index{Verifiability Property} \\
	\hline
	\ref{bkm:incacc:dallasebola} & Dallas Hospital Ebola Incident & A man suffering from Ebola was mistakenly sent home from a Dallas hospital. He later returned to hospital, was diagnosed but died; two nurses contracted Ebola but survived. & Medical & 2014 & \index{Completeness!Property}\Gls{completeness}, \gls{format}{\index{Format Property}} \\
	\hline
	\ref{bkm:incacc:qantastakeoff} & Qantas \index{Boeing 737}Boeing 737 Take-Off & Two independent and inadvertent data entry\index{Data!Entry} errors meant weight used when calculating take-off performance was 10 tonnes less than actual weight. Tail strike. & Air & 2014 & \index{Integrity Property}\Gls{integrity}, \gls{verifiability}\index{Verifiability Property} \\
	\hline
	\ref{bkm:incacc:qantasloading} & Qantas \index{Boeing 737}Boeing 737 Loading & Default settings meant that children were incorrectly recorded as adults, resulting in incorrect aircraft weight and balance. Take-off safety speed was exceeded by about 25 knots. & Air & 2014 & \index{Completeness!Property}\Gls{completeness}, \index{Fidelity / Representation Property}\gls{fidelity}\\
	\hline
	\ref{bkm:incacc:navscor} & Grounding of \dsiwgTextIT{Navigator Scorpio} & The \dsiwgTextIT{Navigator Scorpio} was sailing with out-of-date charts, the planned route was not checked and positional fixes were not taken as often as required. The vessel was grounded, but refloated on the rising tide, with no damage. After the event, false \gls{information} was added to the navigation chart. & Maritime & 2014 & \gls{timeliness}\index{Timeliness Property}, \gls{verifiability}\index{Verifiability Property} \\
	\hline
	\ref{bkm:incacc:mq9reaper} & Loss of MQ-9 reaper & The \gls{gcs} station was \cbstart misconfigured \cbend following a change from MQ-1 to MQ-9 operations. The misconfiguration was not spotted. It caused any throttle position aft of full forward to command negative thrust. The aircraft decelerated below stall speed and impacted ground in unpopulated area. & Air (Defence) & 2012 & \index{Consistency!Property}\Gls{consistency}, \gls{verifiability}\index{Verifiability Property} \\
	\hline

        \ref{bkm:incacc:737-33A} & \index{Boeing 737}Boeing 737-33A at Chambery Airport, France & Misuse of Electronic Flight Bag results in tail strike & Air & 2012 &\Gls{timeliness}\index{Timeliness Property}, \gls{suppression}\index{Suppression Property}, \gls{lifetime}\index{Lifetime Property} \\
        \hline
        
	\ref{bkm:incacc:hermes450} & Loss of Hermes 450 & While attempting an automatic landing the \gls{uas} self-aborted. This abort was due to an incorrect set-up parameter that had been loaded by the crew. The crew elected to intervene rather than let the \gls{uas} self-recover. The air vehicle hit a new, unoccupied hangar; it was ultimately deemed ``non-repairable''. & Air (Defence) & 2011 & \index{Integrity Property}\Gls{integrity} \\
	\hline
	\ref{bkm:incacc:advocatelutheran} & Advocate Lutheran Hospital & An infant boy died after a series of medical errors: incorrect \gls{information} was entered into an electronic intravenous order; automatic alerts had been turned off; and a bag was mislabelled. & Medical & 2010 & \index{Integrity Property}\Gls{integrity}, \gls{verifiability}. \\
	\hline
	\ref{bkm:incacc:sichemosprey} & Grounding of \dsiwgTextIT{Sichem Osprey} & Anti-collision radar thresholds were apparently set incorrectly; there were also sizeable discrepancies between positions plotted on a chart and those displayed on the radar. The vessel grounded at more than 16 knots; no pollution occurred. & Maritime & 2010 & \index{Integrity Property}\Gls{integrity}, \index{Accuracy Property}\gls{accuracy} \\
	\hline
	\ref{bkm:incacc:cootamundra} & Near Collision of Trains, Cootamundra\index[locationidx]{Australia!New South Wales!Cootamundra} & Following a signalling\index{Signalling, Railway} system design error, a passenger train had to unexpectedly apply its brakes; it stopped just 5 m short of a goods train. & Rail & 2009 & \index{Integrity Property}\Gls{integrity}, \index{Completeness!Property}\gls{completeness} \\
	\hline
	...
	\hline
	\ref{bkm:incacc:canterbury} & Grounding of \dsiwgTextIT{The Pride of Canterbury} & An unapproved \gls{ecs} was apparently being used as the primary means of navigation for the passenger ferry \dsiwgTextIT{The Pride of Canterbury}. Due to user settings a charted wreck would not have been displayed on this system. The vessel grounded on the wreck, causing severe damage to her port propeller system. & Maritime & 2008 & \index{Accuracy Property}\Gls{accuracy}, \index{Completeness!Property}\gls{completeness}, \gls{intended_destination} \\
	\hline
	\ref{bkm:incacc:lot282} & LOT Flight 282 & Incorrect data input to the Flight Management System, `E' rather than `W', meant loss of instruments. Aircraft had to return to \gls{lhr}. & Air & 2008 & \index{Integrity Property}\Gls{integrity}, \index{Fidelity / Representation Property}\gls{fidelity} \\
	\hline
        ...
        Maritime & 2007 & \index{Integrity Property}\Gls{integrity}, \gls{verifiability}\index{Verifiability Property}, \index{Fidelity / Representation Property}\gls{fidelity} \\
        \hline
        \ref{bkm:incacc:comair5191} & Comair Flight 5191 & Inaccurate (out-of-date) aerodrome charts led to take-off being attempted from the wrong runway. Aircraft overran the runway; 49 fatalities. & Air & 2006 & \Gls{timeliness}\index{Timeliness Property}, \index{Completeness!Property}\gls{completeness} \\
	\hline
	...
	\hline
	\ref{bkm:incacc:fortdrum} & Fort Drum Artillery Incident & Movement of an artillery site led to errors in targeting. Artillery shells were fired more than a mile off target: 2 soldiers killed; 13 injured. & Defence & 2002 & \index{Integrity Property}\Gls{integrity}, \gls{verifiability}\index{Verifiability Property} \\
	\hline
	\ref{bkm:incacc:washprison} & Early release from Washington State Prison & A software update led to miscalculation of the time an inmate was due to serve in prison. Although the results of the calculation could easily be checked, the problem persisted for 13 years and over 2,000 offenders were released early. & Policing & 2002 & \index{Integrity Property}\Gls{integrity}, \gls{verifiability}\index{Verifiability Property} \\
	\hline
	...
	\hline
	\ref{bkm:incacc:nimitzhill} & Crash into Nimitz Hill, Guam & \Gls{cfit}; the ground-based \gls{msaw} designed to alert air traffic controllers had been inhibited. 228 fatalities; 26 serious injuries. & Air & 1997 & \index{Continuity Property}\Gls{continuity}, \index{Fidelity / Representation Property}\gls{fidelity}\\
	\hline
        \ref{bkm:incacc:sanbernardino} &
        ...
        Rail & 1989 & \index{Integrity Property}\Gls{integrity}, \index{Completeness!Property}\gls{completeness}, \index{Accuracy Property}\gls{accuracy}, \gls{timeliness}\index{Timeliness Property}, \gls{verifiability}\index{Verifiability Property}, \index{Fidelity / Representation Property}\gls{fidelity}, \gls{lifetime}\index{Lifetime Property} \\
        \hline
	\ref{bkm:incacc:peigneur} & Lake Peigneur Drilling Accident & While drilling a test well, a rig crew inadvertently caused a flood in a nearby salt mine. The previously freshwater lake became a salt water lake and the flow of a river was reversed. & Oil and Gas & 1980 & \Gls{verifiability}\index{Verifiability Property} \\
	\hline
...
\begin{itemize}
	\item Neither \glspl{spm} nor Post Office Limited were able to access the full data necessary to identify the source of accounting discrepancies \cite[\textsection 995]{citation:bates_v_pol} and in particular \glspl{spm}' ``ability to
	...
	\item Fujitsu, apparently on Post Office Limited's instruction, changed accounting transactions without the knowledge of the \glspl{spm} responsible for those transactions \cite[\textsection 61.4]{citation:bates_v_pol_tech}.
...
\subsection{Battle of Agincourt}\index[locationidx]{France}\label{bkm:incacc:agincourt}
  ...
  \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} and
  ...
  \dsiwgTextIT{\index{Fidelity / Representation Property}\gls{fidelity}} property.
  ...
  \dsiwgTextIT{\gls{timeliness}\index{Timeliness Property} property}.
...
\Glspl{data property} involved: The approximation was a loss of the \index{Accuracy Property}\gls{accuracy} property.
Its introduction resulted from a lack of consideration of celestial movement,
and so could potentially also be regarded as a loss of both the \dsiwgTextIT{\index{Traceability Property}\gls{traceability}} and \dsiwgTextIT{\index{Fidelity / Representation Property}\gls{fidelity}} properties.
...
\Glspl{data property} involved: The ambiguities can lead to loss of \dsiwgTextIT{\index{Integrity Property}\gls{integrity}},
...
\cbstart\subsection{Java\index{Java} log4j\index{Log4j} Library Vulnerability}\cbend\label{bkm:incacc:log4j}
...
\Gls{data property} involved: \dsiwgTextIT{\index{Integrity Property}\gls{integrity}.}
...
\Glspl{data property} involved: \index{Integrity Property}\gls{integrity}, \index{Accuracy Property}\gls{accuracy} and possibly \dsiwgTextIT{\gls{traceability}} and \gls{verifiability}\index{Verifiability Property}.
...
Finally, it is an example of where an error is known to the system, but not reported (adequately) to the user (Data Category: Dynamic\index{Dynamic Data}, \index{Property!Data}Properties lost: \dsiwgTextIT{\gls{timeliness}\index{Timeliness Property}, \index{Availability Property}\gls{availability}}).
...
\Gls{mcas}\index{MCAS} did not compare data from the two sensors in order to detect a discrepancy between them, and hence indicate that the sensor data was not trustworthy (data category: {dynamic data}; properties lost: \index{Integrity Property}\gls{integrity}, \index{Accuracy Property}\gls{accuracy}, \index{Fidelity / Representation Property}\gls{fidelity}; \glspl{mitigation}\index{Mitigation} unused: redundancy). Furthermore, the function (outside MCAS\index{MCAS}) to report a discrepancy between the sensors to the pilots was not enabled, reducing the crew's ability to respond appropriately (data category: dynamic\index{Dynamic Data}; \index{Property!Data}properties lost: \dsiwgTextIT{\index{Availability Property}\gls{availability}}).
...
\begin{itemize}
    ...
    \item The \gls{aoa} sensor fitted to flight 610 was incorrectly calibrated during a previous repair,
      ...
      (Data Category: Justification\index{Justification Data}; \index{Property!Data}Properties lost: \dsiwgTextIT{\index{Availability Property}\gls{availability}, \index{Fidelity / Representation Property}\gls{fidelity}, \gls{verifiability}\index{Verifiability Property}}).
    \item The evidence of the testing of the \gls{aoa} sensor after fitting to flight 610 by the maintenance crew was erroneous (Data Category: Justification\index{Justification Data}; Properties lost: \dsiwgTextIT{\index{Integrity Property}\gls{integrity}, \index{Availability Property}\gls{availability}, \gls{verifiability}\index{Verifiability Property}})
    \item 31 pages were missing from the maintenance log-book for flight 610, including the records of the testing of the \gls{aoa} sensor after fitting to the aircraft (Data Category: Asset\index{Asset Data}; \index{Property!Data}Properties lost: \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}, \index{Availability Property}\gls{availability}, \gls{verifiability}\index{Verifiability Property}})
...
This is an example of a problem with data in the Adaptation category\index{Adaptation Data}, which did not map correctly to the real-world entity that it was modelling, and hence lost the \dsiwgTextIT{\index{Fidelity / Representation Property}\gls{fidelity}} property. Other properties that were lost include \dsiwgTextIT{\index{Integrity Property}\gls{integrity} and \gls{verifiability}\index{Verifiability Property}.}
...
This incident highlights the importance of the \dsiwgTextIT{\index{Availability Property}\gls{availability}} \index{Property!Data}\gls{data property}, as the data had been silently unavailable to trains. In addition, much of the digital audit trail relating to the failure was lost during repeated attempts to correct the problem and get the rail network running again, a loss of the \dsiwgTextIT{\gls{history}\index{History Property}} \index{Property!Data}\gls{data property}.
...
This incident potentially illustrates the importance of the \dsiwgTextIT{\index{Fidelity / Property}\gls{fidelity}} and \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} \index{Property!Data}\glspl{data property}, with respect to the \gls{egpws} \gls{database}, and the \index{Accuracy Property}\gls{accuracy} \index{Property!Data}\gls{data property}, with respect to the route guides.
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Fidelity / Representation Property}\gls{fidelity}} \gls{data property}, with respect to the modelling, and the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} \index{Property!Data}\gls{data property}, with respect to the persistence time of the saturation flag.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} \index{Property!Data}\gls{data property}. It also shows the applicability of Data Safety Guidance to areas that are not traditionally encompassed by safety engineering.
...
This accident highlights the importance of the \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} \index{Property!Data}\gls{data property}, specifically with respect to the torque calibration\index{Torque Calibration} parameters.
...
This incident highlights the importance of the \dsiwgTextIT{\gls{resolution}}\index{Property!Data} \gls{data property}, specifically with regards to resolving a trawler and a merchant vessel. It also highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}}, specifically with regards to the \gls{information} provided from the sonar\index{Sonar} team to the command team. 
...
\begin{itemize}
  ...
  \item ``Civil Aviation Authority of Nepal\index[locationidx]{Nepal} must ensure that raw \gls{information aeronautical} / data are provided by the aerodrome authorities taking into account of its \index{Accuracy Property}accuracy and \index{Integrity Property}\gls{integrity} requirements for \gls{aeronautical data} as specified by \gls{icao} Annex 15 and its \ecapitalisewords{\glsentrytext{information aeronautical}} Service Manual.''
\end{itemize}

This incident highlights the importance of three \index{Property!Data}\cbstart\glspl{data property}:\cbend\ \index{Accuracy Property}\gls{accuracy}; \dsiwgTextIT{\gls{timeliness}\index{Timeliness Property}}; and \dsiwgTextIT{\gls{verifiability}}\index{Verifiability Property}. All of these apply to data describing the runway's location.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} and \dsiwgTextIT{\gls{format}}{\index{Format Property}} \index{Property!Data}\glspl{data property}, in that \gls{information} about the Ebola\index{Ebola} outbreak was apparently either not available, or not available in a usable form, to decision makers.
...
The \gls{atsb} also identified that the \index{Qantas}Qantas procedure for conducting a check of the Vref40 speed could be misinterpreted. This negated the effectiveness of that check as a defence for identifying data entry\index{Data!Entry} errors. In this case, uncorrected errors affected the \index{Integrity Property}\gls{integrity} of the data used to calculate take-off parameters.

This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} and \dsiwgTextIT{\gls{verifiability}}\index{Verifiability Property} \index{Property!Data}\glspl{data property}, with respect to the data used to calculate take-off performance data\index{Performance Data}.
...
This incident demonstrates the importance of the \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} Data \index{Property!Data}y (i.e., ensuring that the mandatory ``Gender Description'' field was completed) and the \dsiwgTextIT{\index{Fidelity / Representation Property}\gls{fidelity}} \index{Property!Data}\gls{data property} (i.e., ensuring the calculated aircraft loads and balances reflect the real situation). It also illustrates some potential difficulties associated with the use of default data.
...
This incident highlights the importance of the \dsiwgTextIT{\gls{timeliness}\index{Timeliness Property}} \index{Property!Data}\gls{data property}, with respect to both the additional North Sea charts and the master's check of the passage plan.

In addition, the fluidity of the chart data allowed the 2/O to make false post-grounding additions to create an incorrect impression. According to the \glsfmtshort{maib}'s report, such actions are not uncommon. These actions affect the \dsiwgTextIT{\gls{verifiability}}\index{Verifiability Property} of the chart data, which makes post-accident investigations\index{Investigation!Incident / Accident} more complicated.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Consistency!Property}\gls{consistency}} \index{Property!Data}\gls{data property}, with respect to the differences between the \gls{gcs} settings and the aircraft it was meant to be controlling. It also highlights the importance of the \dsiwgTextIT{\gls{verifiability}}\index{Verifiability Property} \glspl{data property}, with respect to the \gls{gcs} settings (and, in particular, the limitations of using checklists to verify data).
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} \index{Property!Data}\gls{data property}, with respect to the \gls{gtols} data loaded by the crew.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} and \dsiwgTextIT{\gls{verifiability}} \index{Verifiability Property}\glspl{data property}, for example with regard to: the \gls{information} in the \gls{iv} order; the bag label; and the blood test results.
...
This incident highlights the role of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} \index{Property!Data}\gls{data property}, with respect to the chart plots, and the \index{Accuracy Property}\gls{accuracy} \index{Property!Data}\gls{data property}, with respect to the alarm thresholds which did not reflect the Captain's wishes.
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} \index{Property!Data}\gls{data property}, with respect to the control table data, and the \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} \index{Property!Data}\gls{data property}, with respect to data produced by the testing and the quality control processes.
...
This incident highlights the importance of the \dsiwgTextIT{\gls{verifiability}} \index{Verifiability Property}\gls{data property}, especially with regards to default (and \gls{adaptation data}\index{Adaptation Data}).
...
This incident highlights the importance of the \index{Accuracy Property}\gls{accuracy} \index{Property!Data}\gls{data property}, with regards to the \gls{information} displayed on the electronic chart. It also highlights the importance of the \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} \index{Property!Data}\gls{data property}, with regards to training (and training records) and the \dsiwgTextIT{\gls{intended_destination}} \index{Property!Data}\gls{data property}, with regards to the inappropriate use of the \gls{vms} data.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} and \dsiwgTextIT{\index{Fidelity / Representation Property}\gls{fidelity}} \index{Property!Data}\glspl{data property}, specifically with respect to coordinates.
...
This incident involved incorrect data, that could have been identified if the software had highlighted the unusual aspects of the data such as the container dimensions to the operator. From a data perspective, the \index{Property!Data}properties that needed to be maintained were \dsiwgTextIT{\index{Integrity Property}\gls{integrity}, \gls{verifiability}}\index{Verifiability Property} and \dsiwgTextIT{\index{Fidelity / Representation Property}\gls{fidelity}.}
...
This incident highlights the importance of the \dsiwgTextIT{\gls{timeliness}\index{Timeliness Property}} \index{Property!Data}\gls{data property}, specifically with regards to the charts. The \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} \index{Property!Data}\gls{data property} is also relevant, given that neither the ``after hours'' changes on Fridays nor the local \gls{notam} were communicated appropriately.
...
This incident illustrates the importance of the following \index{Property!Data}\glspl{data property}: \dsiwgTextIT{\index{Consistency!Property}\gls{consistency}}, with regards to the instructions provided to Flight 2937; \dsiwgTextIT{\index{Availability Property}\gls{availability}}, with regards to \gls{information} from the ground-based optical system; and \dsiwgTextIT{\gls{timeliness}\index{Timeliness Property}}, with regards to \gls{information} from the radar system.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} and \dsiwgTextIT{\gls{verifiability}}\index{Verifiability Property} \glspl{data property}, specifically with respect to the location and elevation data.
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} \index{Property!Data}\gls{data property}, with respect to calculated release dates. The \dsiwgTextIT{\gls{verifiability}} \index{Verifiability Property}\gls{data property} is also relevant, noting that the calculation of the release date was readily verifiable (as shown by the actions of the family of the assault victim).
...
This incident highlights the importance of the \dsiwgTextIT{\index{Consistency!Property}\gls{consistency}} \index{Property!Data}\gls{data property}.
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Continuity Property}\gls{continuity} \index{Property!Data}}\gls{data property}, with respect to the \gls{msaw} coverage, and the \dsiwgTextIT{\index{Fidelity / Representation Property}\gls{fidelity}} \index{Property!Data}\gls{data property},
regarding
...
From the \gls{criticality} of the weight \gls{information}, \index{Safety Requirement!Data!Derived}derived safety requirements could be developed for the various data sources that were used to derive the weight. Such requirements could be expected to highlight the \index{Property!Data}properties of \index{Integrity Property}\gls{integrity}, \index{Completeness!Property}\gls{completeness}, \index{Accuracy Property}\gls{accuracy}, \gls{timeliness}\index{Timeliness Property}, \gls{verifiability}\index{Verifiability Property}, \index{Fidelity / Representation Property}\gls{fidelity} and \gls{lifetime}\index{Lifetime Property}.
...
This incident highlights the importance of the \dsiwgTextIT{\gls{verifiability}} \index{Verifiability Property}\gls{data property}, specifically with regards to the location of the rig. Note that this property was relevant both when the rig started to drill and also during the post-incident investigation\index{Investigation!Incident / Accident}.
