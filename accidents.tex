...
Data properties involved: The ambiguities can lead to loss of \dsiwgTextIT{\index{Integrity Property}\gls{integrity}},
...
Data Property involved: \dsiwgTextIT{\index{Integrity Property}\gls{integrity}.}
...
Data properties involved: \index{Integrity Property}\gls{integrity}, \index{Accuracy Property}\gls{accuracy} and possibly \dsiwgTextIT{Traceability} and Verifiability\index{Verifiability Property}.
...
This incident potentially illustrates the importance of the \dsiwgTextIT{\index{Fidelity/Representation Property}\gls{fidelity}} and \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} \index{Property!Data}Data Properties, with respect to the \gls{egpws} \gls{database}, and the \index{Accuracy Property}\gls{accuracy} \index{Property!Data}Data Property, with respect to the route guides.
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Fidelity/Representation Property}\gls{fidelity}} Data Property, with respect to the modelling, and the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} \index{Property!Data}Data Property, with respect to the persistence time of the saturation flag.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} \index{Property!Data}Data Property. It also shows the applicability of Data Safety Guidance to areas that are not traditionally encompassed by safety engineering.
...
This incident highlights the importance of the \dsiwgTextIT{resolution} \index{Property!Data}Data Property, specifically with regards to resolving a trawler and a merchant vessel. It also highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}}, specifically with regards to the \gls{information} provided from the sonar\index{Sonar} team to the command team. 
...
This incident highlights the importance of the \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} and \dsiwgTextIT{format} \index{Property!Data}Data Properties, in that \gls{information} about the Ebola\index{Ebola} outbreak was apparently either not available, or not available in a usable form, to decision makers.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} and \dsiwgTextIT{verifiability}\index{Verifiability Property} \index{Property!Data}Data Properties, with respect to the data used to calculate take-off performance data\index{Performance Data}.
...
This incident demonstrates the importance of the \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} Data \index{Property!Data}y (i.e., ensuring that the mandatory ``Gender Description'' field was completed) and the \dsiwgTextIT{\index{Fidelity/Representation Property}\gls{fidelity}} \index{Property!Data}Data Property (i.e., ensuring the calculated aircraft loads and balances reflect the real situation). It also illustrates some potential difficulties associated with the use of default data.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} \index{Property!Data}Data Property, with respect to the \gls{gtols} data loaded by the crew.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} and \dsiwgTextIT{verifiability} \index{Verifiability Property}Data Properties, for example with regard to: the \gls{information} in the \gls{iv} order; the bag label; and the blood test results.
...
This incident highlights the role of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} \index{Property!Data}Data Property, with respect to the chart plots, and the \index{Accuracy Property}\gls{accuracy} \index{Property!Data}Data Property, with respect to the alarm thresholds which did not reflect the Captain's wishes.
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} \index{Property!Data}Data Property, with respect to the control table data, and the \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} \index{Property!Data}Data Property, with respect to data produced by the testing and the quality control processes.
...
This incident highlights the importance of the \index{Accuracy Property}\gls{accuracy} \index{Property!Data}Data Property, with regards to the \gls{information} displayed on the electronic chart. It also highlights the importance of the \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} \index{Property!Data}Data Property, with regards to training (and training records) and the \dsiwgTextIT{intended destination / usage} \index{Property!Data}Data Property, with regards to the inappropriate use of the \gls{vms} data.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} and \dsiwgTextIT{\index{Fidelity/Representation Property}\gls{fidelity}} \index{Property!Data}Data Properties, specifically with respect to coordinates.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} and \dsiwgTextIT{verifiability}\index{Verifiability Property} Data Properties, specifically with respect to the location and elevation data.
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} \index{Property!Data}Data Property, with respect to calculated release dates. The \dsiwgTextIT{verifiability} \index{Verifiability Property}Data Property is also relevant, noting that the calculation of the release date was readily verifiable (as shown by the actions of the family of the assault victim).
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Continuity Property}\gls{continuity} \index{Property!Data}}Data Property, with respect to the \gls{msaw} coverage, and the \dsiwgTextIT{\index{Fidelity/Representation Property}\gls{fidelity}} \index{Property!Data}Data Property,
regarding
