...
\begin{longtable}{|C{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.16}}|L{\dsiwgColumnWidth{0.37}}|L{\dsiwgColumnWidth{0.14}}|L{\dsiwgColumnWidth{0.1}}|L{\dsiwgColumnWidth{0.15}}|}
  ...
  %
        ...
        Medical & 2020 & \index{Integrity Property}Integrity, \index{Completeness!Property}\gls{completeness}, Timeliness\index{Timeliness Property}, \index{Availability Property}\gls{availability}, \index{Fidelity/Representation Property}\gls{fidelity}\\
        \hline
	\ref{bkm:incacc:737max8} & Boeing 737 MAX~8 crashes &
	...
	& Air & 2018 \& 2019 & \index{Integrity Property}Integrity, \index{Completeness!Property}\gls{completeness}, \index{Accuracy Property}\gls{accuracy}\vspace{1ex} \index{Availability Property}\gls{availability}, Verifiability\index{Verifiability Property}, \index{Fidelity/Representation Property}\gls{fidelity}\\ 
	\hline
        ...
        & Space & 2017 & \index{Fidelity/Representation Property}\Gls{fidelity}, \index{Integrity Property}Integrity, Verifiability\index{Verifiability Property} \\
        \hline
	\ref{bkm:incacc:cambrian} & Cambrian Line Data Loss &
	...
	\hline
	\ref{bkm:incacc:lot282} & LOT Flight 282 & Incorrect data input to the Flight Management System, `E' rather than `W', meant loss of instruments. Aircraft had to return to \gls{lhr}. & Air & 2008 & \index{Integrity Property}Integrity, \index{Fidelity/Representation Property}\gls{fidelity} \\
	\hline
        ...
        Maritime & 2007 & \index{Integrity Property}Integrity, Verifiability\index{Verifiability Property}, \index{Fidelity/Representation Property}\gls{fidelity} \\
        \hline
	...
	\hline
        ...
        Rail & 1989 & \index{Integrity Property}Integrity, \index{Completeness!Property}\gls{completeness}, \index{Accuracy Property}\gls{accuracy}, Timeliness\index{Timeliness Property}, Verifiability\index{Verifiability Property}, \index{Fidelity/Representation Property}\gls{fidelity}, Lifetime \\
        \hline
...
\Gls{mcas}\index{MCAS} did not compare data from the two sensors in order to detect a discrepancy between them, and hence indicate that the sensor data was not trustworthy (Data Category: Dynamic\index{Dynamic Data}; Properties lost: \index{Integrity Property}Integrity, \index{Accuracy Property}\gls{accuracy}, \index{Fidelity/Representation Property}\gls{fidelity}; Mitigations\index{Mitigation} unused: redundancy). Furthermore, the function (outside MCAS\index{MCAS}) to report a discrepancy between the sensors to the pilots was not enabled, reducing the crew's ability to respond appropriately (Data Category: Dynamic\index{Dynamic Data}; \index{Property!Data}Properties lost: \dsiwgTextIT{\index{Availability Property}\gls{availability}}).
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Fidelity/Representation Property}\gls{fidelity}} Data Property, with respect to the modelling, and the \dsiwgTextIT{\index{Integrity Property}integrity} \index{Property!Data}Data Property, with respect to the persistence time of the saturation flag.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}integrity} and \dsiwgTextIT{\index{Fidelity/Representation Property}\gls{fidelity}} \index{Property!Data}Data Properties, specifically with respect to coordinates.
...
From the \gls{criticality} of the weight information, \index{Safety Requirement!Data!Derived}derived safety requirements could be developed for the various data sources that were used to derive the weight. Such requirements could be expected to highlight the \index{Property!Data}properties of \index{Integrity Property}Integrity, \index{Completeness!Property}\gls{completeness}, \index{Accuracy Property}\gls{accuracy}, Timeliness\index{Timeliness Property}, Verifiability\index{Verifiability Property}, \index{Fidelity/Representation Property}\gls{fidelity} and Lifetime.
