...
\begin{longtable}{|C{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.16}}|L{\dsiwgColumnWidth{0.37}}|L{\dsiwgColumnWidth{0.14}}|L{\dsiwgColumnWidth{0.1}}|L{\dsiwgColumnWidth{0.15}}|}
  ...
  Accountancy & 1999 & \Gls{integrity}\index{Integrity Property}, Completeness\index{Completeness Property}, \gls{traceability}\index{Traceability Property}, \gls{verifiability}\index{Verifiability Property}, History\index{History Property}\\ 
  ...
  Possibly the earliest known \gls{error}: erroneous ``schoolboy knowledge'' that Earth rotates 360$^\circ$ per day sends spacecraft off course
  &
  ...
  %
	...
	\hline
        ...
        \ref{bkm:incacc:737-33A} & \index{Boeing 737}Boeing 737-33A at Chambery Airport, France & Misuse of Electronic Flight Bag results in tail strike & Air & 2012 &\Gls{timeliness}\index{Timeliness Property}, Suppression, Lifetime \\
        \hline
	...
	\hline
        ...
        Rail & 1989 & \index{Integrity Property}\Gls{integrity}, \index{Completeness!Property}\gls{completeness}, \index{Accuracy Property}\gls{accuracy}, \gls{timeliness}\index{Timeliness Property}, \gls{verifiability}\index{Verifiability Property}, \index{Fidelity / Representation Property}\gls{fidelity}, Lifetime \\
        \hline
...
\subsection{Battle of Agincourt}\index[locationidx]{France}\label{bkm:incacc:agincourt}
  ...
  \dsiwgTextIT{\index{\gls{timeliness} property}\gls{timeliness}} property.
...
\Gls{mcas}\index{MCAS} did not compare data from the two sensors in order to detect a discrepancy between them, and hence indicate that the sensor data was not trustworthy (Data Category: Dynamic\index{Dynamic Data}; Properties lost: \index{Integrity Property}\gls{integrity}, \index{Accuracy Property}\gls{accuracy}, \index{Fidelity / Representation Property}\gls{fidelity}; Mitigations\index{Mitigation} unused: redundancy). Furthermore, the function (outside MCAS\index{MCAS}) to report a discrepancy between the sensors to the pilots was not enabled, reducing the crew's ability to respond appropriately (Data Category: Dynamic\index{Dynamic Data}; \index{Property!Data}Properties lost: \dsiwgTextIT{\index{Availability Property}\gls{availability}}).
...
This incident highlights the importance of the \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} and \dsiwgTextIT{format} \index{Property!Data}\glspl{data property}, in that \gls{information} about the Ebola\index{Ebola} outbreak was apparently either not available, or not available in a usable form, to decision makers.
...
This incident highlights the importance of the \index{Accuracy Property}\gls{accuracy} \index{Property!Data}\gls{data property}, with regards to the \gls{information} displayed on the electronic chart. It also highlights the importance of the \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} \index{Property!Data}\gls{data property}, with regards to training (and training records) and the \dsiwgTextIT{intended destination / usage} \index{Property!Data}\gls{data property}, with regards to the inappropriate use of the \gls{vms} data.
