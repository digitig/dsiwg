...
\begin{longtable}{|C{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.16}}|L{\dsiwgColumnWidth{0.37}}|L{\dsiwgColumnWidth{0.14}}|L{\dsiwgColumnWidth{0.1}}|L{\dsiwgColumnWidth{0.15}}|}
  ...
  Accountancy & 1999 & \Gls{integrity}\index{Integrity Property}, Completeness\index{Completeness Property}, \gls{traceability}\index{Traceability Property}, Verifiability\index{Verifiability Property}, History\index{History Property}\\ 
  ...
  %
        ...
        Medical & 2021 & \index{Integrity Property}\Gls{integrity}, \index{Accuracy Property}\gls{accuracy}, \gls{traceability}, Verifiability\index{Verifiability Property}\\
        \hline
	...
	& Air & 2018 \& 2019 & \index{Integrity Property}\Gls{integrity}, \index{Completeness!Property}\gls{completeness}, \index{Accuracy Property}\gls{accuracy}\vspace{1ex} \index{Availability Property}\gls{availability}, Verifiability\index{Verifiability Property}, \index{Fidelity/Representation Property}\gls{fidelity}\\ 
	\hline
        ...
        & Space & 2017 & \index{Fidelity/Representation Property}\Gls{fidelity}, \index{Integrity Property}\gls{integrity}, Verifiability\index{Verifiability Property} \\
        \hline
	\ref{bkm:incacc:cambrian} & Cambrian Line Data Loss &
	...
	\hline
	\ref{bkm:accinc:turkisha330} & Turkish Airlines A330 & Inaccurate navigation data, relating to runway location, led to touchdown with left main gear off the paved surface. Aircraft written off. & Air & 2015 & \index{Accuracy Property}\Gls{accuracy}, \gls{timeliness}\index{Timeliness Property}, Verifiability\index{Verifiability Property} \\
	\hline
	...
	\hline
	\ref{bkm:incacc:qantastakeoff} & Qantas \index{Boeing 737}Boeing 737 Take-Off & Two independent and inadvertent data entry\index{Data!Entry} errors meant weight used when calculating take-off performance was 10 tonnes less than actual weight. Tail strike. & Air & 2014 & \index{Integrity Property}\Gls{integrity}, Verifiability\index{Verifiability Property} \\
	\hline
	...
	\hline
        ...
        Maritime & 2007 & \index{Integrity Property}\Gls{integrity}, Verifiability\index{Verifiability Property}, \index{Fidelity/Representation Property}\gls{fidelity} \\
        \hline
	...
	\hline
	\ref{bkm:incacc:fortdrum} & Fort Drum Artillery Incident & Movement of an artillery site led to errors in targeting. Artillery shells were fired more than a mile off target: 2 soldiers killed; 13 injured. & Defence & 2002 & \index{Integrity Property}\Gls{integrity}, Verifiability\index{Verifiability Property} \\
	\hline
	\ref{bkm:incacc:washprison} & Early release from Washington State Prison & A software update led to miscalculation of the time an inmate was due to serve in prison. Although the results of the calculation could easily be checked, the problem persisted for 13 years and over 2,000 offenders were released early. & Policing & 2002 & \index{Integrity Property}\Gls{integrity}, Verifiability\index{Verifiability Property} \\
	\hline
	...
	\hline
        ...
        Rail & 1989 & \index{Integrity Property}\Gls{integrity}, \index{Completeness!Property}\gls{completeness}, \index{Accuracy Property}\gls{accuracy}, \gls{timeliness}\index{Timeliness Property}, Verifiability\index{Verifiability Property}, \index{Fidelity/Representation Property}\gls{fidelity}, Lifetime \\
        \hline
...
\Glspl{data property} involved: \index{Integrity Property}\gls{integrity}, \index{Accuracy Property}\gls{accuracy} and possibly \dsiwgTextIT{\gls{traceability}} and Verifiability\index{Verifiability Property}.
...
\begin{itemize}
    ...
    \item The \gls{aoa} sensor fitted to flight 610 was incorrectly calibrated during a previous repair,
      ...
      (Data Category: Justification\index{Justification Data}; \index{Property!Data}Properties lost: \dsiwgTextIT{\index{Availability Property}\gls{availability}, \index{Fidelity/Representation Property}\gls{fidelity}, Verifiability\index{Verifiability Property}}).
...
This incident highlights the importance of three \index{Property!Data}\cbstart\glspl{data property}:\cbend\ \index{Accuracy Property}\gls{accuracy}; \dsiwgTextIT{\gls{timeliness}\index{Timeliness Property}}; and \dsiwgTextIT{verifiability}\index{Verifiability Property}. All of these apply to data describing the runway's location.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} and \dsiwgTextIT{verifiability}\index{Verifiability Property} \index{Property!Data}\glspl{data property}, with respect to the data used to calculate take-off performance data\index{Performance Data}.
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} and \dsiwgTextIT{verifiability} \index{Verifiability Property}\glspl{data property}, for example with regard to: the \gls{information} in the \gls{iv} order; the bag label; and the blood test results.
...
This incident highlights the importance of the \dsiwgTextIT{verifiability} \index{Verifiability Property}\gls{data property}, especially with regards to default (and \gls{adaptation data}\index{Adaptation Data}).
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} and \dsiwgTextIT{verifiability}\index{Verifiability Property} \glspl{data property}, specifically with respect to the location and elevation data.
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Integrity Property}\gls{integrity}} \index{Property!Data}\gls{data property}, with respect to calculated release dates. The \dsiwgTextIT{verifiability} \index{Verifiability Property}\gls{data property} is also relevant, noting that the calculation of the release date was readily verifiable (as shown by the actions of the family of the assault victim).
...
From the \gls{criticality} of the weight \gls{information}, \index{Safety Requirement!Data!Derived}derived safety requirements could be developed for the various data sources that were used to derive the weight. Such requirements could be expected to highlight the \index{Property!Data}properties of \index{Integrity Property}\gls{integrity}, \index{Completeness!Property}\gls{completeness}, \index{Accuracy Property}\gls{accuracy}, \gls{timeliness}\index{Timeliness Property}, Verifiability\index{Verifiability Property}, \index{Fidelity/Representation Property}\gls{fidelity} and Lifetime.
...
This incident highlights the importance of the \dsiwgTextIT{verifiability} \index{Verifiability Property}\gls{data property}, specifically with regards to the location of the rig. Note that this property was relevant both when the rig started to drill and also during the post-incident investigation\index{Investigation!Incident/Accident}.
