...
\begin{longtable}{|C{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.16}}|L{\dsiwgColumnWidth{0.37}}|L{\dsiwgColumnWidth{0.14}}|L{\dsiwgColumnWidth{0.1}}|L{\dsiwgColumnWidth{0.15}}|}
  ...
  Accountancy & 1999 & \Gls{integrity}\index{Integrity Property}, Completeness\index{Completeness Property}, Traceability\index{Traceability Property}, Verifiability\index{Verifiability Property}, History\index{History Property}\\ 
  ...
  %
        ...
        Medical & 2021 & \index{Integrity Property}\Gls{integrity}, \index{Accuracy Property}\gls{accuracy}, Traceability, Verifiability\index{Verifiability Property}\\
        \hline
        ...
        Medical & 2020 & \index{Integrity Property}\Gls{integrity}, \index{Completeness!Property}\gls{completeness}, Timeliness\index{Timeliness Property}, \index{Availability Property}\gls{availability}, \index{Fidelity/Representation Property}\gls{fidelity}\\
        \hline
	\ref{bkm:incacc:737max8} & Boeing 737 MAX~8 crashes &
	...
	\hline
        ...
        Rail & 1989 & \index{Integrity Property}\Gls{integrity}, \index{Completeness!Property}\gls{completeness}, \index{Accuracy Property}\gls{accuracy}, Timeliness\index{Timeliness Property}, Verifiability\index{Verifiability Property}, \index{Fidelity/Representation Property}\gls{fidelity}, Lifetime \\
        \hline
...
and so could potentially also be regarded as a loss of both the \dsiwgTextIT{\index{Traceability Property}Traceability} and \dsiwgTextIT{\index{Fidelity/Representation Property}\gls{fidelity}} properties.
...
\Glspl{data property} involved: \index{Integrity Property}\gls{integrity}, \index{Accuracy Property}\gls{accuracy} and possibly \dsiwgTextIT{Traceability} and Verifiability\index{Verifiability Property}.
...
This incident highlights the importance of three \index{Property!Data}\cbstart\glspl{data property}:\cbend\ \index{Accuracy Property}\gls{accuracy}; \dsiwgTextIT{timeliness\index{Timeliness Property}}; and \dsiwgTextIT{verifiability}\index{Verifiability Property}. All of these apply to data describing the runway's location.
...
This incident highlights the importance of the \dsiwgTextIT{timeliness\index{Timeliness Property}} \index{Property!Data}\gls{data property}, with respect to both the additional North Sea charts and the master's check of the passage plan.
...
This incident highlights the importance of the \dsiwgTextIT{timeliness\index{Timeliness Property}} \index{Property!Data}\gls{data property}, specifically with regards to the charts. The \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} \index{Property!Data}\gls{data property} is also relevant, given that neither the ``after hours'' changes on Fridays nor the local \gls{notam} were communicated appropriately.
...
From the \gls{criticality} of the weight \gls{information}, \index{Safety Requirement!Data!Derived}derived safety requirements could be developed for the various data sources that were used to derive the weight. Such requirements could be expected to highlight the \index{Property!Data}properties of \index{Integrity Property}\gls{integrity}, \index{Completeness!Property}\gls{completeness}, \index{Accuracy Property}\gls{accuracy}, Timeliness\index{Timeliness Property}, Verifiability\index{Verifiability Property}, \index{Fidelity/Representation Property}\gls{fidelity} and Lifetime.
